...
public final class StreamingValidation {
    ...
    internal static func validateSettings(_ settings: LiveStreamSettings) throws {
        // RTMP URL 검사
    ...
    internal static func validateForPlatform(_ settings: LiveStreamSettings, platform: StreamingPlatform) -> PlatformValidationResult {
        switch platform {
        case .youtube:
    ...
    private static func validateForYouTube(_ settings: LiveStreamSettings) -> PlatformValidationResult {
        var warnings: [String] = []
    ...
    private static func validateForTwitch(_ settings: LiveStreamSettings) -> PlatformValidationResult {
        var warnings: [String] = []
        var recommendations: [String] = []
    ...
    private static func validateForFacebook(_ settings: LiveStreamSettings) -> PlatformValidationResult {
        var warnings: [String] = []
        var recommendations: [String] = []
    ...
    private static func validateForCustom(_ settings: LiveStreamSettings) -> PlatformValidationResult {
        return PlatformValidationResult(
            isValid: true,
            warnings: [],
