...
USB External Camera는 UVC 호환 USB 외부 카메라를 사용하여 iPad 최적화 라이브 스트리밍을 제공하는 전문 iOS 애플리케이션입니다. HaishinKit 2.0.8 기반으로 YouTube Live 실시간 RTMP 송출을 지원하며, 480p/720p/1080p 프리셋, 화면 캡처 기반 합성(카메라 + UI), 안정성 중심 프레임 파이프라인 제어를 제공합니다.
...
- 🚧 마이크 음소거 토글 기능은 현재 개발 중이며 UI에서 임시 비활성화되어 있습니다
