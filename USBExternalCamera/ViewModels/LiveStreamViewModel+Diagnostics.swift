...
extension LiveStreamViewModel {
  ...
  func requestCameraPermission() async -> Bool {
    ...
    logInfo(status ? "✅ [PERMISSION] Camera allowed" : "❌ [PERMISSION] Camera denied", category: .camera)
    return status
  }
  ...
  func requestMicrophonePermission() async -> Bool {
    ...
    logInfo(status ? "✅ [PERMISSION] Microphone allowed" : "❌ [PERMISSION] Microphone denied", category: .camera)
    return status
  }
